        ...
        <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary/10 rounded-lg p-6 border-l-4 border-primary mb-8 text-center">
            <p className="text-lg font-semibold text-charcoal">
              Patron: His Excellency Lieutenant General Sir John Lorimer KCB DSO MBE and Lady Lorimer MBE.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ul className="space-y-3">
            {[
              'Social Activities and other Matters may be sent via email',
              'A newsletter will be produced at regular intervals and distributed electronically via email to all members',
        ...
        <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <Card>
              ...
              <p className="text-gray-700 mb-4">
                Members can usually bring non-members to events at the PAYG rate where appropriate, although on rare occasions this may not be possible.
              </p>
        ...
        <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <Card>
              ...
              <ul className="space-y-3">
                {[
                  'Annual General Meeting (AGM) will be convened by the Secretary who shall issue a Calling Notice and Agenda to each Club member in advance of the AGM',
